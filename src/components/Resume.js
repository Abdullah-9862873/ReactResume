...
function Resume() {
  ...
  return (
            ...
            <div className="relative">
              <div className="absolute right-[7.3rem] bottom-[45px] flex justify-center items-center">
                ...
                <a
                  ...
                  className="inline-block items-center justify-center ml-[7px] font-LatoItalic font-semibold tracking-wide"
                >
                  ag9862873@gmail.com
                </a>
              </div>
	...
	C44.177,52.078,38.672,54.958,32.521,55.763z"
                ...
                <div className="inline-block items-center justify-center ml-[7px] font-mono tracking-tight">
                  abdullah-sultan.info
                </div>
              </div>
            </div>
          </div>
          ...
          {/* Section 2 */}
          <div className="h-[25rem] bg-[#e8ffed] relative">
            {/* First Logo */}
            ...
            {/* Second Logo */}
            <div className="absolute left-[170px] top-[46px] w-[250px]">
              <MyIcon />
            </div>
            {/* Third Logo */}
            <div className="w-[150px] absolute left-[471px] top-[0px] flex justify-center">
              <NodeIcon />
            </div>
            {/* Fourth Logo */}
            <div className="w-[150px] absolute left-[674px] top-[15px]">
              <ReactIcon />
            </div>
            {/* Fifth Logo */}
            <div className="w-[150px] absolute left-[877px] top-[2px]">
              <SassIcon />
            </div>
            {/* Sixth Logo */}
            <div className="w-[200px] absolute left-[1050px] top-[45px]">
              <MongodbIcon />
            </div>
            {/* Seventh Logo */}
            <div className="w-[100px] absolute left-[30px] top-[180px]">
              <TailwindIcon />
            </div>
            {/* Eigth Logo */}
            <div className="absolute left-[190px] top-[180px] w-[250px]">
              <AzureIcon />
            </div>
            {/* Nineth Logo */}
            <div className="absolute left-[490px] top-[150px]">
              <PythonIcon />
            </div>
            {/* Tenth Logo */}
            <div className="absolute left-[674px] top-[154px]">
              <ExpressIcon />
            </div>
            {/* Eleventh Logo */}
            <div className="w-[240px] absolute left-[850px] top-[153px]">
              <img src={reduxImage} alt="My Image" />
            </div>

            {/* Twelveth Logo */}
            <div className="absolute left-[1110px] top-[180px]">
              <JQueryIcon />
            </div>

            {/* Thirteenth Logo */}
            <div className="absolute left-[30px] top-[290px]">
              <GitHubIcon />
            </div>

            {/* Fourteenth Logo */}
            <div className="absolute left-[170px] top-[290px]">
            ...
            {/* Sixteenth Logo */}
            <div className="absolute left-[674px] top-[300px]">
              <JavaIcon />
            </div>
            ...
            {/* Eighteenth Logo */}
            <div className="absolute left-[1110px] top-[280px] w-[100px] h-[100px]">
              <RestApi />
            </div>
          </div>
            ...
            <div className="w-[50%]">
              ...
              <div className="h-[33px] w-[31.25rem]">
                <div className="mt-[20px] flex bg-[#e8ffed] border-t-[2px] border-b-[2px] border-r-[2px] border-l-[0] rounded-t-xl rounded-r-xl rounded-b-xl rounded-l-none ">
                  <div className="w-[100px] ml-[42px]">
                    <img
                      src="https://www.pasha.org.pk/pashapk/WhatsApp-Image-2021-12-29-at-11.00.25-AM.jpeg"
                      alt="My Image"
                    />
                  </div>
                  <div className="ml-[42px] font-PlayfairDisplayMedium font-semibold">
              ...
              <div className="ml-[4rem] flex mt-[10px]">
                ...
                <span className="ml-[34px]">
                  ...
                  <span className="font-LatoItalic font-semibold">
                    4+ software systems
                  </span>{" "}
              ...
              <div className="h-[33px] w-[31.25rem]">
                <div className="mt-[20px] flex bg-[#e8ffed] border-t-[2px] border-b-[2px] border-r-[2px] border-l-[0] rounded-t-xl rounded-r-xl rounded-b-xl rounded-l-none ">
                  <div className="w-[100px] ml-[42px]">
                    <img
                      className="bg-[#151515]"
                      src="https://cdn-epmnb.nitrocdn.com/peNqlMnodEogCXHBaKyAuwiqzlWcHwBe/assets/images/optimized/rev-b073c09/wp-content/uploads/2019/08/logo-1.png"
                      alt="My Image"
                    />
                  </div>
                  <div className="ml-[42px] font-PlayfairDisplayMedium font-semibold">
                    Feb 2022- June 2022 (5 months)
                  </div>
                </div>
              </div>
              ...
              <div className="h-[33px] w-[31.25rem]">
                <div className="mt-[20px] flex bg-[#e8ffed] border-t-[2px] border-b-[2px] border-r-[2px] border-l-[0] rounded-t-xl rounded-r-xl rounded-b-xl rounded-l-none ">
                  ...
                  <div className="ml-[24px] font-PlayfairDisplayMedium font-semibold">
                    Aug 2021 - continue
                  </div>
                </div>
              </div>
              ...
              <div className="ml-[4rem] flex mt-[10px]">
                ...
                <span className="ml-[36px]">
                  ...
                  technologies such as Node.js and Express js.
                </span>
              </div>
            ...
            <div className="w-[43%]">
              ...
              <div className="h-[33px] w-[100%]">
                <div className="mt-[30px] flex bg-[#e8ffed] border-t-[2px] border-b-[2px] border-r-[0px] border-l-[2px] rounded-t-xl rounded-r-none rounded-b-xl rounded-l-xl ">
                  ...
                  <div className="ml-[20px] font-PlayfairDisplayMedium font-semibold">
              ...
              <p className="ml-[89px] mt-[20px]">
                ...
                <span className="font-LatoItalic font-semibold">front-end</span>{" "}
                functionality.
              </p>
              <div className="ml-[5.5rem] flex mt-[10px]">
                <span>
